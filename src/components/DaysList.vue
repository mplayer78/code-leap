...
const validChallenges = challenges.filter(ch => new Date() > new Date(ch.date))
...
<template>
  <ul class="challenge__list">
    <li v-for="challenge, index in validChallenges" :key="challenge.id" class="challenge__item">
